...
let largeShirts = [];
runners.filter(function(e){
	return e['shirt_size'] == 'L';
}).forEach(function(e){
	largeShirts.push("Contact " + e.first_name + " " + e.last_name + " " + e.email + " to pick a different size");
});
...
runners.reduce(function(x=0,e){
	ticketPriceTotal = x+e.donation;
})
